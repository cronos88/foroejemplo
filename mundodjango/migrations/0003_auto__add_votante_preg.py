...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Votante_preg'
        db.create_table(u'mundodjango_votante_preg', (
        ...
        db.send_create_signal(u'mundodjango', ['Votante_preg'])


    def backwards(self, orm):
        # Deleting model 'Votante_preg'
        db.delete_table(u'mundodjango_votante_preg')
