...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Votante_resp'
        db.create_table(u'mundodjango_votante_resp', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('usuario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('respuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mundodjango.Respuestas'])),
        ))
        db.send_create_signal(u'mundodjango', ['Votante_resp'])


    def backwards(self, orm):
        # Deleting model 'Votante_resp'
        db.delete_table(u'mundodjango_votante_resp')
